...
# Kernel core
KERNEL_SRC = src/kernel/kernel.c src/kernel/console.c src/kernel/keyboard.c src/kernel/timer.c src/kernel/klog.c src/kernel/process.c src/kernel/syscall.c src/kernel/elf.c
KERNEL_OBJ = src/kernel/kernel.o src/kernel/console.o src/kernel/keyboard.o src/kernel/timer.o src/kernel/klog.o src/kernel/process.o src/kernel/syscall.o src/kernel/elf.o
