...
#define CR4_OSXMMEXCPT                                                         \
  (1 << 10)                    /* OS Support for Unmasked SIMD FPU Exceptions */
#define CR4_FSGSBASE (1 << 16) /* Enable FSGSBASE instructions */
 ...
 */
static inline void cpuid_ext(uint32_t leaf, uint32_t subleaf, uint32_t *eax,
