...
static inline void local_cli(void) { __asm__ volatile("cli"); }

/* Legacy function - no longer needed */
void console_set_hhdm_offset(uint64_t hhdm_offset) { (void)hhdm_offset; }
...
void console_init(void) { spinlock_init(&console_lock); }
...
void console_scroll_up(void) { /* Not implemented for framebuffer */ }

void console_scroll_down(void) { /* Not implemented for framebuffer */ }
...
int console_get_view_line(void) { return 0; }

int console_get_current_line(void) { return 0; }
